...
#Variable Setting
current_event_id='12' #지금 진행중인 이벤트 ID
current_event_name = 'Period of NOCTURNE' #지금 진행중인 이벤트 이름
event_start_date = '2021-01-31 16:00' #이벤트 시작하는 날짜
event_end_date = '2021-02-07 21:00' #이벤트 끝나는 날짜
...
font = ImageFont.truetype(os.path.join(sys.path[0], 'NotoSansCJKkr-Regular.otf'),30)
scrfont = ImageFont.truetype(os.path.join(sys.path[0], 'NotoSansCJKkr-Medium.otf'),30)
